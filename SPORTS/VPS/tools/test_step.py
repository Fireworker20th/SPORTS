...
def parse_args():
    ...
    parser.add_argument('--pan_im_json_file', type=str, default='/media/jydai/C0FED904FED8F39E/download_jyd/project/Video-K-Net-main/data/cityscapes_vps/panoptic_im_val_city_vps.json')
