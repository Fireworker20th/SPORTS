                    ...
                    if is_first:
                        ...
                        for model in range(4):
                            if model == 0:
                                ...
                                ref_rpn_results = self.rpn_head.forward_train(x_fusion_map1, x_fusion_map1, ref_img_metas_new, ref_gt_masks,
                                                                              ref_labels_gt, ref_gt_sem_seg,
                                                                              ref_gt_sem_cls)
                                (ref_rpn_losses, ref_proposal_feats, ref_x_feats, ref_mask_preds,
                                 ref_cls_scores) = ref_rpn_results
                    ...
                    if is_first:
                        ...
                        for model1 in range(4):
                            if model1 == 0:
                                ...
                                rpn_results2 = self.rpn_head.forward_train(x_fusion_map2, x_fusion_map2, img_metas, gt_masks,
                                                                          gt_labels, gt_sem_seg,
                                                                          gt_sem_cls)
