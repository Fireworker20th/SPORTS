...
class VideoKNetQuansiEmbedFCJointTrain(BaseDetector):
    ...
    def data_for_fusion(self, img_meta, ref_img_metas_new):
        ...
        depth_file = os.path.join(
            "/media/jydai/C0FED904FED8F39E/download_jyd/project/Video-K-Net-main/data/viper/video/val_G/depth",
            depth_name)
        flow_file = os.path.join(
            "/media/jydai/C0FED904FED8F39E/download_jyd/project/Video-K-Net-main/data/viper/video/val_G/flow",
            name)
        pose_file = os.path.join(
            "/media/jydai/C0FED904FED8F39E/download_jyd/project/Video-K-Net-main/data/viper/video/val_G/pose",
            pose_name)
