...
class VideoKNetQuansiEmbedFCJointTrain(BaseDetector):
    ...
    def data_for_fusion(self, img_meta, ref_img_metas_new):
        ...
        root = os.path.join(
            ...
            what)
        root_depth = "/media/jydai/C0FED904FED8F39E/download_jyd/project/Video-K-Net-main/data/vkitti2/ALL_clone/video/depth_anything_vkitti2"
        ...
        depth_file = os.path.join(root_depth, depth_name)
