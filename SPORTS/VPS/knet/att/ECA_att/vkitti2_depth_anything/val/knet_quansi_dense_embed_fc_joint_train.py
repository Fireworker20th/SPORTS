...
class VideoKNetQuansiEmbedFCJointTrain(BaseDetector):
    ...
    def data_for_fusion(self, img_meta, ref_img_metas_new):
        ...
        depth_part1 = "{:06d}".format(int(part1))
        depth_part2 = "{:06d}".format(part2)
        ...
        depth_name = depth_part1 + '_' + depth_part2 + '_depth.png'
        depth_file = os.path.join(
            "/media/jydai/C0FED904FED8F39E/download_jyd/project/Video-K-Net-main/data/vkitti2/ALL_clone/video/depth_anything_vkitti2",
            depth_name)
