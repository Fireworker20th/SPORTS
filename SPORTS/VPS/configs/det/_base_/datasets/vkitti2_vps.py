dataset_type = 'VKITTI2DVPSDataset'
...
train_pipeline = [
    ...
    dict(type='LoadMultiAnnotationsDirect', with_depth=False, divisor=-1, cherry_pick=True, cherry=[11, 12, 13]),
    dict(type='SeqResizeWithDepth', img_scale=(375, 1242), ratio_range=[0.5, 2.0], keep_ratio=True),
    dict(type='SeqFlipWithDepth', flip_ratio=0.5),
    dict(type='SeqRandomCropWithDepth', crop_size=(375, 1242), share_params=True),
