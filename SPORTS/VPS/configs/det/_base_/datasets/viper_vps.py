dataset_type = 'VIPERDVPSDataset'
data_root = '/media/jydai/C0FED904FED8F39E/download_jyd/project/Video-K-Net-main/data/viper'
...
train_pipeline = [
    ...
    dict(type='LoadMultiAnnotationsDirect', with_depth=False, divisor=-1, cherry_pick=True, cherry=[10, 13, 14, 16, 17, 18, 19, 20, 21, 22]),
    dict(type='SeqResizeWithDepth', img_scale=(1080, 1920), ratio_range=[0.5, 2.0], keep_ratio=True),
    dict(type='SeqFlipWithDepth', flip_ratio=0.5),
    dict(type='SeqRandomCropWithDepth', crop_size=(1080, 1920), share_params=True),
