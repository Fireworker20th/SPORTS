...
#flow_path = "/media/jydai/C0FED904FED8F39E/download_jyd/project/PVO-main/shared_data/full_flow" # "shared_data/full_flow"
flow_path = "/media/jydai/C0FED904FED8F39E/download_jyd/project/Video-K-Net-main/data/viper/video/val_G/flow" # "shared_data/full_flow"
flow_names = os.listdir(flow_path)
flow_names.sort()
#depth_path = '/media/jydai/C0FED904FED8F39E/download_jyd/project/PVO-main/shared_data/depth'
depth_path = '/media/jydai/C0FED904FED8F39E/download_jyd/project/Video-K-Net-main/data/viper/video/val_G/depth'
depth_names = os.listdir(depth_path)
depth_names.sort()
segment_dir = "/media/jydai/C0FED904FED8F39E/download_jyd/project/PVO-main/shared_data/panoptic_segm_fusion/inference/pan_seg"
...
for idx in range(len(seg_list)): 
    ...
    if has_depth:
        #depth = np.array(Image.open(os.path.join(depth_path, cur_depth_f))) / 100
        depth = 300 - np.array(Image.open(os.path.join(depth_path, cur_depth_f)))
    ...
    if cur_seq_id != seq_id:
        ...
        ref_flow = cv2.resize(ref_flow, (1080, 1920))
