    ...
    def __getitem__(self, index):
        ...
        if self.aug is not None:
            if self.flow_label:
                ...
                images, poses, disps, intrinsics = self.aug(images, poses, disps, intrinsics, gt_masks=None,
                                                            gt_vals=None, segments=None)
        ...
        if self.flow_label:
            ...
            if self.mode == 'sup':
                ...
                return filename_list, images, poses, disps, intrinsics
