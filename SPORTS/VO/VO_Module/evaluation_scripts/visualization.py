...
def droid_visualization(video, device="cuda:0"):
    ...
    def animation_callback(vis):
        ...
        with torch.no_grad():
            ...
            #image_id = torch.index_select(video.images_id, 0, dirty_index)
            #image_id = image_id.cpu()[:, [2, 1, 0], 3::8, 3::8].permute(0, 2, 3, 1) / 255.0
            ...
            for i in range(len(dirty_index)):
                ...
                #clr = image_id[i].reshape(-1, 3)[mask].cpu().numpy()
                ...
                frame_point_clouds.append(o3d.geometry.PointCloud())
                frame_point_clouds[-1].points = o3d.utility.Vector3dVector(pts)
                frame_point_clouds[-1].colors = o3d.utility.Vector3dVector(clr)

                global_point_cloud += frame_point_clouds[-1]

                ply_filename = f"/media/jydai/C0FED904FED8F39E/download_jyd/project/PVO-main/shared_data/PC/global_point_cloud.ply"
                o3d.io.write_point_cloud(ply_filename, global_point_cloud)
